        ...
        <div className="mx-auto grid w-full max-w-7xl grid-cols-[auto_1fr_auto] items-center gap-4 px-5 py-2.5 md:px-10">
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            <button
              ...
              className="hidden min-h-[38px] items-center border border-[#F59E0B]/40 bg-[#F59E0B]/10 px-4 font-mono text-[0.58rem] uppercase leading-none tracking-[0.2em] text-[#F59E0B] transition hover:bg-[#F59E0B]/20 sm:inline-flex"
            >
              Request access
            </button>
        ...
        {open && (
          <div className="border-t border-white/[0.07] bg-[#080C14]/97 px-5 pb-5 pt-1 backdrop-blur-xl md:hidden">
            ...
            <button
              ...
              className="mt-4 flex min-h-[46px] w-full items-center justify-center border border-[#F59E0B]/40 bg-[#F59E0B]/10 font-mono text-[0.62rem] uppercase tracking-[0.2em] text-[#F59E0B]"
            >
              Request access
            </button>
          </div>
